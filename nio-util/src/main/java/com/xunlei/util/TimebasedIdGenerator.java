...
public class TimebasedIdGenerator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // TimebasedIdGenerator g = new TimebasedIdGenerator(4, false);// 1s最多生成1w个
        ...
        // }
        // log.error("span:{},{}", System.currentTimeMillis() - before, g);// accuracyLen=4时,2w次要花两s
    ...
    public long nextLongId() {
        ...
        try {
            ...
            // }
            //
            // } while (lastId == newId); // 如果生成的相同，则再次计算
            // lastId = newId; // 设置 lastPK
        } finally {
            LOCK.unlock();
            if (collideTimes > 0) {
