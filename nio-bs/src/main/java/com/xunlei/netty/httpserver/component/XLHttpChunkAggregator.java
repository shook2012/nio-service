 ...
 * p.addLast("aggregator", <b>new {@link XLHttpChunkAggregator}(1048576)</b>);
 * ...
 ...
 */
public class XLHttpChunkAggregator extends SimpleChannelUpstreamHandler {
...
//    private HttpMessage currentMessage;
     ...
     */
    public XLHttpChunkAggregator(int maxContentLength) {
    ...
    // 2012-05-31 把此类改成单例  
    // 当前类抄自 netty-3.4.6
    // 1. this.currentMessage = m;  改成   ctx.setAttachment(m);
    // 2. HttpMessage currentMessage = this.currentMessage; 改成  HttpMessage currentMessage = (HttpMessage) ctx.getAttachment();
    // 3.    this.currentMessage = null; 改成   ctx.setAttachment(null);
...
//        HttpMessage currentMessage = this.currentMessage;// zengdong-change
        HttpMessage currentMessage = (HttpMessage) ctx.getAttachment();
...
//                this.currentMessage = m;// zengdong-change
                ctx.setAttachment(m);
            } else {
                // Not a chunked message - pass through.
//                this.currentMessage = null;// zengdong-change
