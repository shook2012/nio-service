...
public class ContextBase implements Context {
    ...
    // new LinkedBlockingQueue<Runnable>());//2011-12-16 zengdong改成统一的，方便管理监控
    ExecutorService executorService = ConcurrentUtil.getLogExecutor();
    ...
    /**
     * Set the {@link StatusManager} for this context. Note that by default this context is initialized with a {@link BasicStatusManager}. A null value for the 'statusManager' argument is not allowed.
     * <p/>
     * <p>
