    ...
    public void writeRequested(ChannelHandlerContext ctx, MessageEvent e)
        ...
        if (msg instanceof HttpResponse && ((HttpResponse) msg).getStatus().getCode() == 100) {
            ...
            if (contentEncoding != null &&
                ...
                // 2012-04-16 增加这个判断 实现不是所有响应包都进行gzip
                if (hasContent && HttpHeaders.getContentLength(m) >= HttpServerConfig.getPlAddDefalterContentLen() && (encoder = newContentEncoder(m, acceptEncoding)) != null) {
