...
public abstract class AbstractDiskHttpData extends AbstractHttpData {
    ...
    private File tempFile() throws IOException {
        // 2011-05-27 测试发现上传了中文名字乱码,更严重的是中文名过长时(大概是39个字ok),会造成IOException: File name too long
        // 现在先直接生成文件时,使用随机数字
        ...
        // }
        String newpostfix = System.nanoTime() + ""; // MOD by ZengDong
        File tmpFile;
